...
It's worth noting that the WSGI+ application bears the responsibility of handling both the result and any potential errors during the Future execution. On the other hand, ensuring the proper propagation of the unhandled errors lies with the WSGI+ server.
